...
urlpatterns = [
    ...
    url(r'^one-element-case-api/(?P<pk>\d+)/$', OneElementCaseApi.as_view(), name = "OneElementCaseApi" ),
    url(r'^one-element-case-update-api/(?P<pk>\d+)/$', OneElementCaseUpdateApi.as_view(), name = "OneElementCaseUpdateApi" ),
