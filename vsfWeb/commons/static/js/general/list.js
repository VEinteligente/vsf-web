...
$(document).ready(function() {
	...
	// Correspond to the number of elements in the JSON. Its default value is
	// "0"
	$("#count").html("0");
			...
			.done(
					function(data) {
						...
						$
								.each(
										dataJson,
										function(key, value) { // First Level

											if (key == "count") {
												$("#count").html(value);
											}

											// We need to access this element to
											// get each site/domain data
											if (key == "results") {
												$('#hiddenID').val("");
